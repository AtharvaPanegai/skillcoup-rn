    ...
    <ScrollView>
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={styles.container}>
          ...
          <TouchableOpacity onPress={()=>{navigation.navigate("ProjectPosted")}}>
          ...
          <TouchableOpacity onPress={()=>{navigation.navigate("ProjectAssigned")}}>
            <View style={styles.seperateContainer}>
          ...
          <TouchableOpacity onPress={()=>{navigation.navigate("ProjetCompleted")}}>
            <View style={styles.seperateContainer}>
